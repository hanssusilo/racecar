...
if("TRUE" STREQUAL "TRUE")
  set(racecar_SOURCE_PREFIX /home/racecar/racecar/src/racecar-iap/racecar)
  set(racecar_DEVEL_PREFIX /home/racecar/racecar/devel)
  set(racecar_INSTALL_PREFIX "")
  set(racecar_PREFIX ${racecar_DEVEL_PREFIX})
else()
  set(racecar_SOURCE_PREFIX "")
  set(racecar_DEVEL_PREFIX "")
  set(racecar_INSTALL_PREFIX /home/racecar/racecar/install)
...
if(NOT "/home/racecar/racecar/devel/include " STREQUAL " ")
  set(racecar_INCLUDE_DIRS "")
  set(_include_dirs "/home/racecar/racecar/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'racecar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/racecar/racecar/src/racecar-iap/racecar/${idir}'.  Ask the maintainer 'Michael Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/racecar/racecar/devel/lib;/opt/ros/indigo/lib)
...
set(racecar_EXPORTED_TARGETS "racecar_generate_messages_cpp;racecar_generate_messages_lisp;racecar_generate_messages_py")
...
set(depends "razor_imu_9dof;pointgrey_camera_driver;px4flow;tf;urg_node;joy;laser_scan_matcher;rosbag;pwm_sysfs_driver;joy_to_servo;message_runtime")
